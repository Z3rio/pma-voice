...
| voice_enableCallUi         | 1       | Can be used to specifically disable the calling user interface. `voice_enableUi` has priority over this.                                                                              | int          |
| voice_enableRadioUi        | 1       | Can be used to specifically disable the calling radio interface. `voice_enableUi` has priority over this.                                                                             | int          |
| voice_enableMainUi         | 1       | Can be used to specifically disable the calling main interface. `voice_enableUi` has priority over this.                                                                              | int          |
