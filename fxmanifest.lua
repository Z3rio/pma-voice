...
convar_category 'PMA-Voice' {
	"PMA-Voice Configuration Options",
	{
		...
		{ "Volume of radio on mic click",          "$voice_onClickVolume",        "CV_INT",    "10" },
		{ "Volume of radio off mic click",         "$voice_offClickVolume",       "CV_INT",    "3" },
		...
		{ "Disable radio submix",                  "$voice_disableRadioSubmix",   "CV_INT",    "0" },
		{ "Disable call submix",                   "$voice_disableCallSubmix",    "CV_INT",    "0" },
